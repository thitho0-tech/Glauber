-- 0067: troca a persona do e-mail de convite para o novo ícone (favicon-glauber.png).
-- Mesmo corpo de criar_convite do 0065, só o <img> da persona muda (.jpg -> .png, height 48).
...
as $$
declare
  v_pp record; v_email text; v_token text; v_org uuid;
  v_app_url text; v_link text; v_html text; v_org_rec record; v_existente record;
begin
  ...
  select * into v_existente
    ...
    where projeto_pessoa_id = p_projeto_pessoa_id and status = 'pendente' and expira_em > now()
  ...
  v_html :=
    ...
    || '<img src="https://glauber.app.br/favicon-glauber.png" alt="" height="48" style="vertical-align:middle">'
